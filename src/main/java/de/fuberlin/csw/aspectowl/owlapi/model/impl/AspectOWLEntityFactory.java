...
public class AspectOWLEntityFactory extends CustomOWLEntityFactory {
	...
	public <T extends OWLEntity> OWLEntityCreationSet<T> createOWLEntity(Class<T> type, String shortName, IRI baseURI) throws OWLEntityCreationException {
		try {
			...
			CustomOWLEntityFactory.EntityNameInfo name = generateName(type, shortName, baseURI);
	...
	protected <T extends OWLEntity> CustomOWLEntityFactory.EntityNameInfo generateName(Class<T> type, String shortName, IRI baseURI) throws AutoIDException, URISyntaxException, OWLEntityCreationException {
		...
		return new CustomOWLEntityFactory.EntityNameInfo(iri, id, shortName);
	}


	protected <T extends OWLEntity > List<OWLOntologyChange> getChanges(T entity, CustomOWLEntityFactory.EntityNameInfo name) {
