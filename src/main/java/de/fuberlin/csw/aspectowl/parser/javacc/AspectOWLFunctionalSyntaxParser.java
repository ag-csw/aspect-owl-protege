/* AspectOWLFunctionalSyntaxParser.java */
...
annos.add(anno);
    ...
    advice = Advice();
    jj_consume_token(CLOSEPAR);
{if ("" != null) return df.getOWLAspect(advice, annos);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return df.getOWLAspectAssertionAxiom(joinPoint, advice, axiomAnnos);}
  ...
  final public Set<OWLAspect> AspectSet() throws ParseException {Set<OWLAspect> aspects = new HashSet<OWLAspect>();
...
{if ("" != null) return aspects;}
    throw new Error("Missing return statement in function");
  }

  final public Set<OWLAspect> AxiomAspectSet() throws ParseException {Set<OWLAspect> aspects = new HashSet<OWLAspect>();
    OWLAspect aspect;
    label_23:
    while (true) {
      if (jj_2_134(2)) {
...
{if ("" != null) return joinPoint;}
  ...
  final public OWLClassExpression Advice() throws ParseException {OWLClassExpression advice;
    advice = ClassExpression();
{if ("" != null) return advice;}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return new SPARQLPointcut(aspectAssertionAxiom, query, annotations);}
  ...
  final public OWLModulePointcut ModulePointcut() throws ParseException {OWLAspect aspectAssertionAxiom;
...
{if ("" != null) return new OWLModulePointcut(aspectAssertionAxiom, query, annotations);}
  ...
  final public Set<OWLEntity> Signature() throws ParseException {OWLEntity iri;
