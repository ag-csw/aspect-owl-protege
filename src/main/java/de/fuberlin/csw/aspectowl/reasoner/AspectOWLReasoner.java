...
public class AspectOWLReasoner {
	...
	public static void main2(String[] args) {
		try {
			...
			OWLOntology onto = om.loadOntologyFromOntologyDocument(IRI.create(new File("/Users/ralph/Documents/Diss/Ontologien/Test/Inonconsistent.ofn")));
			PelletIncremantalReasonerFactory rFac = PelletIncremantalReasonerFactory.getInstance();
			...
			try {
				...
				InconsistentOntologyExplanationGeneratorFactory expGenFac = new InconsistentOntologyExplanationGeneratorFactory(rFac, Long.MAX_VALUE);
				ExplanationGenerator<OWLAxiom> expGen = expGenFac.createExplanationGenerator(onto);
				...
				Set<Explanation<OWLAxiom>> explanations = expGen.getExplanations(entailment);
	...
	public static void main(String[] args) {
		try {
			...
			om.addIRIMapper(new XMLCatalogIRIMapper(new File("/Users/ralph/Documents/Diss/Ontologien/AspectOWL/ontology/examples/temporal/catalog-v001.xml")));
			
			OWLOntology onto = om.loadOntologyFromOntologyDocument(IRI.create(new File("/Users/ralph/Documents/Diss/Ontologien/AspectOWL/ontology/examples/temporal/temporal.owl")));
			
			OWLReasoner reasoner = PelletReasonerFactory.getInstance().createReasoner(onto);
	        ...
	        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("/Users/ralph/"));
